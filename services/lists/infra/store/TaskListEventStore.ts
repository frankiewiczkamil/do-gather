import { TaskList, TaskListEventFailed, TaskListIdentifier } from '@/services/lists/TaskList';
...
export function selectTaskList(taskListId: TaskListIdentifier) {
  return calculateTaskListState(taskListEvents, taskListId) as TaskList;
}
